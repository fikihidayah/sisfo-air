...
$config['default_group']              = 'petugas';           // Default group, use name
...
$config['session_hash'] = '6583d6c4f205998ecacc9f51b68a2a2e44ea0012';
 ...
 */
$config['remember_cookie_name'] = 'masuk';
...
$config['message_start_delimiter'] = '<div class="alert alert-success alert-dismissible">'; 	// Message start delimiter
$config['message_end_delimiter']   = '<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button></div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissible">';		// Error message start delimiter
$config['error_end_delimiter']     = '<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button></div>';	// Error message end delimiter
